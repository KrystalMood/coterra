      ...
      <section className="flex h-fit w-full flex-col-reverse items-center justify-between text-slate-50 lg:flex-row">
        <div className="mt-10 flex flex-col lg:mt-0 lg:flex-1">
          ...
          <h1 className="inline cursor-default text-center text-6xl font-bold lg:hidden">
            Unleash Your Creativity in <span className="text-red-800">Coterra</span>
          </h1>
          ...
          <button
            id="get-started"
            className="mx-auto mt-10 h-fit w-fit rounded-md bg-red-800 px-8 py-4 text-xl font-semibold transition-all duration-300 ease-in-out [box-shadow:_0.3rem_0.3rem_0_#991b1b99] hover:bg-red-700 lg:mx-0 lg:mt-8"
          >
            Get Started
          </button>
        </div>
